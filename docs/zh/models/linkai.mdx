...
可选模型：`gpt-4.1-mini`、`gpt-5.4-mini`、`qwen3.8-flash`、`qwen3.7-plus`、`doubao-seed-2-1-pro-260628`、`kimi-k2.6`、`claude-sonnet-5`、`claude-fable-5`、`gemini-3.1-flash-lite-preview` 等。
