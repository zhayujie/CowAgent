...
You can also install and uninstall skills from the Skills page in the web console and desktop app: paste a Skill Hub name or GitHub URL and click Install.
## From the Skill Hub
